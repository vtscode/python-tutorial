...
"""
File app.py adalah file yang menjadi file utama atau bisa kita sebut sebagai controllernya. 
Dimana file ini sebagai objek aplikasi yang menghubungkan antara template melalui fungsi view() 
